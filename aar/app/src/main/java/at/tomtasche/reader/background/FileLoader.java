...
public abstract class FileLoader {
    ...
    public void loadWithType(LoaderType type, Options options) {
        // 移除Firebase Analytics相关代码
        // analyticsManager.report("load_document_" + type.toString().toLowerCase(), FirebaseAnalytics.Param.CONTENT_TYPE, options.fileType);
    ...
    void callOnSuccess(Result result) {
        mainHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                analyticsManager.report("loader_success_" + type);
    ...
    void callOnError(Result result, Throwable t) {
        ...
        mainHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                analyticsManager.report("loader_error_" + type);
